...
import com.example.skillzonee.activities.MateriActivity;
import com.example.skillzonee.activities.QuizActivity;
import com.example.skillzonee.model.MateriModel;

import java.util.List;

public class MateriListAdapter extends RecyclerView.Adapter<MateriListAdapter.MyViewHolder> {

    private final List<MateriModel> materiModelList;

    // Constructor to initialize the Adapter with the list of quiz items
    public MateriListAdapter(List<MateriModel> materiModelList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.bind(materiModelList.get(position));
    }

    @Override
    public int getItemCount() {
        // Return the number of items in the list
        return materiModelList.size();
    }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(MateriModel model) {
